...
const Navbar = () => {
  const inactiveLink = "flex px-2 py-2 gap-1";
  const activeLink = "flex px-2 py-2 gap-1 bg-blue-900 text-white rounded-l-lg";
  const router = useRouter();

  return (
    <aside className="flex-column md:static md:w-auto">
      <div className="flex px-4 py-3">
        ...
        <h1 className="nav_head">EcommerceAdmin</h1>
      </div>

      <nav className="flex flex-col text-blue-900 ml-4 gap-2">
        <Link
          href={"/"}
